...
const storeSchema = mongoose.Schema(
    {
        ...
        // MODIFIED FIELD: Banner can now be an array of image URLs
        banner: {
            type: [String], // Array of URLs from Cloudinary for banner images
            default: [], // Optional, so default to an empty array
        },
